...
?>
<img src="research/aerodynamics.jpg" class="center">
<b>Aerodynamics</b> is the understanding of how to reduce forces on craft aimed at flight.
<br /><br />
...
<tr id="black"><td id="black">Allows Fighter Jets, Bombers, Interceptors</td><td id="black">Physics</td><td id="black"><?php echo number_format($cost); ?> Research Points</td><td id="black"><?php echo number_format($userF['rpoints']); ?> Research Points</td></tr></table></center><br />
...
mysql_query("UPDATE players SET rpoints='$newpoints', aero='1' WHERE id='$id'");
} else {
