...
?>
<img src="research/fission.jpg" class="center">
<b>Nuclear Fission</b> is a nuclear reaction or radioactive decay caused by splitting an atom.
<br /><br />
...
<tr id="black"><td id="black">Leads to Nuclear Weapons</td><td id="black">Atomic Theory, Rocketry</td><td id="black"><?php echo number_format($cost); ?> Research Points</td><td id="black"><?php echo number_format($userF['rpoints']); ?> Research Points</td></tr></table></center><br />
...
if($userF['atomic'] != 1) {
$error .= "Error3 - You can't complete this research until you research Atomic Theory.<br />";
} if($userF['rocketry'] != 1) {
$error .= "Error4 - You can't complete this research until you research Rocketry.<br />";
}


if($error == null) {
$newpoints = $userF['rpoints']-$cost;
mysql_query("UPDATE players SET rpoints='$newpoints', fission='1' WHERE id='$id'");
} else {
