...
?>
<img src="research/rocketry.jpg" class="center">
<b>Rocketry</b> is the development of missiles propelled by burning fuel.
<br /><br />
...
<tr id="black"><td id="black">Allows SAM Batteries and Ballistic Missiles</td><td id="black">Aerodynamics, RADAR</td><td id="black"><?php echo number_format($cost); ?> Research Points</td><td id="black"><?php echo number_format($userF['rpoints']); ?> Research Points</td></tr></table></center><br />
...
if($userF['aero'] != 1) {
$error .= "Error3 - You cannot complete this research until you research Aerodynamics.<br />";
} if($userF['radar'] != 1) {
$error .= "You must research RADAR before you can research Rocketry.<br />";
}


if($error == null) {
$newpoints = $userF['rpoints']-$cost;
mysql_query("UPDATE players SET rpoints='$newpoints', rocketry='1' WHERE id='$id'");
} else {
