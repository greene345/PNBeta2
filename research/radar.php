...
?>
<img src="research/radar.jpg" class="center">
<b>RADAR</b> is the process of using microwaves to locate objects and determine their speed and direction. 
<br /><br />
...
<tr id="black"><td id="black">Leads to Aircraft, Rocketry, and SONAR</td><td id="black">Physics</td><td id="black"><?php echo number_format($cost); ?> Research Points</td><td id="black"><?php echo number_format($userF['rpoints']); ?> Research Points</td></tr></table></center><br />
...
mysql_query("UPDATE players SET rpoints='$newpoints', radar='1' WHERE id='$id'");
} else {
