...
?>
<img src="research/sonar.jpg" class="center">
<b>SONAR</b> is the process of locating objects underwater.
<br /><br />
...
<tr id="black"><td id="black">Allows Submarines</td><td id="black">RADAR</td><td id="black"><?php echo number_format($cost); ?> Research Points</td><td id="black"><?php echo number_format($userF['rpoints']); ?> Research Points</td></tr></table></center><br />
...
if($userF['radar'] != 1) {
$error .= "Error3 - You cannot complete this research until you research RADAR.<br />";
}


if($error == null) {
$newpoints = $userF['rpoints']-$cost;
mysql_query("UPDATE players SET rpoints='$newpoints', sonar='1' WHERE id='$id'");
} else {
