...
?>
<img src="research/physics.jpg" class="center">
<b>Physics</b> is the science of understanding forces in the universe.
<br /><br />
...
<tr id="black"><td id="black">Leads to New Researchable Items</td><td id="black">None</td><td id="black"><?php echo number_format($cost); ?> Research Points</td><td id="black"><?php echo number_format($userF['rpoints']); ?> Research Points</td></tr></table></center><br />
...
mysql_query("UPDATE players SET rpoints='$newpoints', physics='1' WHERE id='$id'");
} else {
