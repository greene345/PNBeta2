...
?>
<img src="research/recycling.jpg" class="center">
<b>Recycling</b> is a leap forward in being environmentally friendly and conserving resources.
<br /><br />
...
<tr id="black"><td id="black">Decrease Pollution Costs to $1.40 per ton</td><td id="black">None</td><td id="black"><?php echo number_format($cost); ?> Research Points</td><td id="black"><?php echo number_format($userF['rpoints']); ?> Research Points</td></tr></table></center><br />
...
mysql_query("UPDATE players SET rpoints='$newpoints', recycling='1' WHERE id='$id'");
} else {
