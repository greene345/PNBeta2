...
?>
<img src="research/ase.jpg" class="center">
<b>Advanced Structural Engineering</b> is great push in the field of architecture. Aside from making city zones cheaper, it allows you to build the Towering Skyscraper Marvel.
<br /><br />
...
<tr id="black"><td id="black">Reduces cost of city zones by 4%, Allows Towering Skyscraper Marvel</td><td id="black">None</td><td id="black"><?php echo number_format($cost); ?> Research Points</td><td id="black"><?php echo number_format($userF['rpoints']); ?> Research Points</td></tr></table></center><br />
...
mysql_query("UPDATE players SET rpoints='$newpoints', ase='1' WHERE id='$id'");
} else {
